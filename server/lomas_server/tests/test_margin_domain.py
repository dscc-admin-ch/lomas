import unittest
import opendp
from dp_queries.dp_libraries.opendp import get_lf_domain, _update_params_by_grouping, _get_global_params
...
class TestMarginDomain(unittest.TestCase):
    ...
    def test_opendp_margin(self) -> None:
        ...
        metadata["columns"]["column_category"]["max_partition_contributions"] = 8
        params = _update_params_by_grouping(metadata, by_config, _get_global_params(metadata))
        ...
        metadata["columns"]["column_category"]["max_partition_contributions"] = 2
        params = _update_params_by_grouping(metadata, by_config, _get_global_params(metadata))
        ...
        metadata["columns"]["column_category"]["max_influenced_partitions"] = 1
        metadata["columns"]["column_category"]["max_partition_contributions"] = 2
        metadata["columns"]["column_category_2"]["max_influenced_partitions"] = 3
        metadata["columns"]["column_category_2"]["max_partition_contributions"] = 4
        params = _update_params_by_grouping(metadata, by_config, _get_global_params(metadata))
        self.assertEqual(params["max_partition_contributions"], 8)
        self.assertEqual(params["max_influenced_partitions"], 3)
        self.assertEqual(params["max_partition_length"], 60)
        ...
        del metadata["columns"]["column_category"]["max_partition_contributions"]
        del metadata["columns"]["column_category"]["max_influenced_partitions"]
