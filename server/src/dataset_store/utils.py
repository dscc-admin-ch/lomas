from constants import CONF_DATASET_STORE_TYPE_BASIC, CONF_DATASET_STORE_TYPE_LRU
...
def dataset_store_factory(config: DatasetStoreConfig, admin_database: AdminDatabase) -> DatasetStore:
    """
