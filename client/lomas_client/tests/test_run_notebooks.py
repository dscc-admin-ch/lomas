...
def mark_notebook(notebooks: list[Path]) -> list[NamedTuple]:
    marks = {
        ...
        "Demo_Client_Notebook.ipynb": pytest.mark.long,
        ...
        "Penguin_Research.ipynb": pytest.mark.skip(reason="How do you even VAR in ODP ???"),  # ~9s
...
def test_run_notebook(notebook: Path) -> None:
    ...
    """
    run_notebook(notebook, run_demo_setup=True, save_output=False)
