...
def test_serialize_deserialize():
    ...
    example_expected_json = (
        ...
        '{"n_components": 2, "copy": true, "whiten": false, "random_state": '
        'null, "centered": true, "epsilon": 1.0, "data_norm": 5, '
        '"bounds": null, "accountant": "_dpl_instance:BudgetAccountant"}}, '
        '{"type": "_dpl_type:LogisticRegression", "name": "lr", '
        '"params": {"tol": 0.0001, "C": 1.0, "fit_intercept": true, '
